    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (result?.token) {
                ...
                // Якщо "Keep me logged in" має щось робити — тут можна зберігати refresh token / флаг.
                // Поки що просто залишаємо чекбокс як UI.
            ...
            // Підлаштуй під твою структуру помилок з бекенду
            setError(err?.data?.message ?? "Помилка входу. Перевір дані.");
        }
    };
